import type { ApplicationCommand, AutocompleteInteraction, ButtonInteraction, Collection, CommandInteraction, ContextMenuInteraction, Interaction, Message, ModalSubmitInteraction, SelectMenuInteraction, Snowflake } from "discord.js";
import { Client as ClientJS } from "discord.js";
import type { ClientOptions, DApplicationCommand, DApplicationCommandGroup, DApplicationCommandOption, DComponent, DDiscord, DiscordEvents, DOn, DSimpleCommand, GuardFunction, IGuild, InitCommandOptions, IPrefix, IPrefixResolver, ISimpleCommandByName, SimpleCommandConfig } from "./index.js";
