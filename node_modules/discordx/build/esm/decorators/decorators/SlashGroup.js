...
export function SlashGroup(options, root) {
    return function (target, key, descriptor) {
        if (typeof options === "string") {
            ...
            const clazz = target;
            if (options.root) {
                MetadataStorage.instance.addApplicationCommandSlashSubGroups(DApplicationCommandGroup.create(options.name, { description: options.description }).decorate(clazz, clazz.name));
            }
            else {
