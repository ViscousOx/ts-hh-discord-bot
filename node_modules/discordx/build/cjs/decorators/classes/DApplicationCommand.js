...
class DApplicationCommand extends Method_js_1.Method {
    ...
    toSubCommand() {
        const option = index_js_1.DApplicationCommandOption.create(this.name, undefined, undefined, this.description, undefined, undefined, undefined, undefined, "SUB_COMMAND").decorate(this.classRef, this.key, this.method, this.from, this.index);
