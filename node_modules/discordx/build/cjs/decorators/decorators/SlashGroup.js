...
function SlashGroup(options, root) {
    return function (target, key, descriptor) {
        if (typeof options === "string") {
            ...
            const clazz = target;
            if (options.root) {
                index_js_1.MetadataStorage.instance.addApplicationCommandSlashSubGroups(index_js_1.DApplicationCommandGroup.create(options.name, { description: options.description }).decorate(clazz, clazz.name));
            }
            else {
