...
function SlashOption(name, options) {
    ...
    return function (target, key, index) {
        ...
        const option = index_js_1.DApplicationCommandOption.create(name, options?.autocomplete, options?.channelTypes, options?.description, index, options?.maxValue, options?.minValue, options?.required, type, options?.descriptionLocalizations, options?.nameLocalizations).decorate(target.constructor, key, target[key], target.constructor, index);
